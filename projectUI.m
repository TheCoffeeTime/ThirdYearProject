...
currentModelPath = '/Users/Thanakorn/Documents/ThirdYearProject/models/01_mfcc.mat';
initAudioFilePath = '/Users/Thanakorn/Documents/MATLAB/speech-data/trainChildren/ks61g3w0.wav';
...
MB11 = uicontrol( 'String', 'Online Testing', 'Callback', {@onlinebtn_callback,cardPanel}, 'Parent', MB1);
MB12 = uicontrol( 'String', 'Offline Testing', 'Callback', {@offlinebtn_callback,cardPanel}, 'Parent', MB1);
MB1.Sizes = [-1, -5, -5];
MB20 = uicontrol( 'Style', 'text', 'String', 'Training', 'Parent', MB2, 'HorizontalAlignment', 'left');
MB21 = uicontrol( 'String', 'Create & Evaluate a model', ...
...
CP21231 = uicontrol( 'String', 'Test', 'Callback', @TAF_callback, 'Parent', CP2123);
CP212.Sizes = [-1, 160, -1, 160, -1, 60];
CP212111 = uicontrol( 'String', 'play', 'Callback', @playAudio_callback, 'Parent', CP21211);
CP212112 = uicontrol( 'String',initAudioFilePath, 'BackgroundColor', 'w', 'Style', 'edit', ...
                      'Parent', CP21211, 'FontSize', 12, 'Tag', 'currentAFile');
CP212113 = uicontrol( 'String', 'Browse', 'Callback', {@browseWAV_callback, CP212112}, 'Parent', CP21211);
...
CP212213 = uicontrol( 'String', 'Browse', 'Callback', {@browseMAT_callback, CP212212}, 'Parent', CP21221);
...
CP112.Sizes = [-1, -3, -1];
CP11221 = uicontrol( 'String', 'Test my voice', 'Callback', @TMV_callback, 'Parent', CP1122);
...
CP112222 = uicontrol('Parent', CP11222 ,'String', 'Select a model', ...
                      'Callback', {@browseMAT_callback, CP212212});
CP11222.Sizes = [-1, -4];
...
CP311113 = uicontrol('Parent', CP31111, 'String', 'Create a model', 'Callback', @createModel_callback);
CP31111.Sizes = [-2, -7, -3];
...
CP311123 = uicontrol('Parent', CP31112, 'String', 'Browse', 'Callback', {@SFP_callback, CP311122});
CP31112.Sizes = [-2, -7, -3];
...
CP311133 = uicontrol('Parent', CP31113, 'String', 'Browse', 'Callback', {@SFP_callback, CP311132});
CP31113.Sizes = [-2, -7, -3];

CP311141 = uiextras.VBox('Parent', CP31114);
CP3111411 = uicontrol('Parent', CP311141, 'Style', 'checkbox', 'String', 'MFCC', 'Tag', 'MFCCselected');
CP3111412 = uicontrol('Parent', CP311141, 'Style', 'checkbox', 'String', 'Pitch and Formants', 'Tag', 'PFSelected');
...
CP312113 = uicontrol('Parent', CP31211, 'String', 'Browse', 'Callback', {@browseMAT_callback, CP312112});
CP312114 = uicontrol('Parent', CP31211, 'String', 'Evaluate a model', 'Callback', @evaluateModel_callback);
...
CP312123 = uicontrol('Parent', CP31212, 'String', 'Browse', 'Callback', {@SFP_callback, CP312122});
CP31212.Sizes = [-2, -7, -3];
...
CP312133 = uicontrol('Parent', CP31213, 'String', 'Browse', 'Callback', {@SFP_callback, CP312132});
CP31213.Sizes = [-2, -7, -3];
